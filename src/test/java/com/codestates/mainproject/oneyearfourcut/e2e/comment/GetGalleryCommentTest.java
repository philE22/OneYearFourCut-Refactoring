...
public class GetGalleryCommentTest {
    ...
    void successGetTest() throws Exception {
        ...
        ResultActions actions = mockMvc.perform(
                get("/galleries/{gallery-id}/comments",
        ...
        actions.andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.commentList[2].commentId").value(artworkComment1.getCommentId()))
                .andExpect(jsonPath("$.commentList[1].commentId").value(artworkComment2.getCommentId()))
                .andExpect(jsonPath("$.commentList[0].commentId").value(galleryComment1.getCommentId()));
